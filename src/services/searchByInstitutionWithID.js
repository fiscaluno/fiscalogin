...
const searchInstitutionWithID = axios.create({
  baseURL: "https://private-f15175-fiscalunoapi.apiary-mock.com/institutions/",
  timeout: 5000,
  headers: {
    "X-Client-ID":
...
export default searchInstitutionWithID;
